...
const Comments = (props: ICommentsProps): JSX.Element => {
  ...
  const countActiveComments = () =>
    data!.filter(
      (comment) =>
        comment.from <= currentTime && (comment.to === undefined || comment.to >= currentTime),
    ).length;
  ...
  return (
    ...
    >
      ...
      <Menu tabular className="dapplet-comments-menu">
        <Menu.Item name={CommentBlock.Empty} active={activeTab === CommentBlock.Empty} />
        <Menu.Item
              ...
              .filter((commentData) => {
                ...
                switch (activeTab) {
                  ...
                  case CommentBlock.Active:
                    return (
                      !hidden && from <= currentTime && (to === undefined || to >= currentTime)
                    );
      ...
      <div style={{ display: 'flex' }}>
        ...
        >
          <Button color="violet" className="action-button exact" onClick={handleGoToCCPage}>
            Add comment
          </Button>
        </div>
        <div
